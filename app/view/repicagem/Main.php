                ...
                while ($data = $limite->fetch(PDO::FETCH_ASSOC)) {
                    ...
                    <div class="row">
                        ...
                        <div class="cell" data-title="Ações">
                            ...
                            <button class='btn btn-sm btn-danger' type='button' id='excluir' name="btn_excluir" onclick="btn_excluir(<?= $data['id'] ?>)">Excluir<span class='glyphicon glyphicon-trash'></span></button>
                                    ...
                                    <div class="container">                    
                                        <form action="" method="post" id="formEspecie" class="form-horizontal">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-3">
                                                    <input type="text" value="<?= $data["material"] ?>" name="material" id="material" class="form-control" disabled="true">
                                                </div>
                                            </div>
...
<!--=========================================================================-->
<div class="container">                    
    <form action="<?= DIRPAGE . '/repicagem?pagina=1' ?>" method="post" id="formEspecie" class="form-horizontal" style="display:none;">
        <h1 style='font-weight:bold;'>Repicagem</h1>
        <hr>
        <div class="form-group">
